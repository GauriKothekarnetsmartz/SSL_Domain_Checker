...
# Function to fetch domain registration expiration
...
highlight_fill_green = PatternFill(start_color='00FF00', end_color='00FF00', fill_type='solid')    # Green for within 1 month but not within 15 days
